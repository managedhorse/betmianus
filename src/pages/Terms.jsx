          ...
          <Box bgGradient={appBlueGradient} p="1.5" rounded="xl" boxShadow="2xl">
            <Box bg="white" color="gray.800" rounded="lg" p={{ base: 6, md: 10 }}>
              ...
              <OrderedList pl={5} mb={4}>
                ...
                <ListItem>If you detect an error or bug, you won’t exploit it and will report it immediately.</ListItem>
                <ListItem>
              ...
              <Text mb={2}>
                You may not use the Service if you are located in or a resident of any of the following jurisdictions:
              </Text>
              ...
              <UnorderedList pl={5} mb={4}>
                <ListItem>
                  We may declare a wager void (in whole or part) if we determine that outcomes were influenced,
                  rules were circumvented, criminal activity occurred, technical errors occurred, or
                  odds/markets were misquoted/misconfigured.
                </ListItem>
                <ListItem>
                  If a confirmed deposit has an insufficient network fee or is flagged as invalid,
              ...
              <UnorderedList pl={5} mb={4}>
                ...
                <ListItem>
                  Winnings (if any) are credited after results are confirmed. We may adjust payouts made in error.
                </ListItem>
                <ListItem>Account balances and records maintained by Bet Mianus are deemed final unless proven otherwise.</ListItem>
              </UnorderedList>
              ...
              <UnorderedList pl={5} mb={4}>
                ...
                <ListItem>Our total liability to you for any claim shall not exceed €100.</ListItem>
              </UnorderedList>
              ...
              <UnorderedList pl={5} mb={4}>
                ...
                <ListItem>After the period ends, you may request reinstatement via customer support (subject to checks).</ListItem>
              </UnorderedList>

              <Heading size="md" mt={8} mb={2}>18. Contact</Heading>
              <Text mb={1}>Support: <strong>betmianus-support@googlegroups.com</strong></Text>
              <Text mb={0}>Legal/Notices: <strong>admin@betmian.us</strong></Text>
            </Box>
          </Box>
        </Container>
      </Box>
